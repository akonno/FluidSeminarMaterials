...
**KodingBasics** は，クイズを通してプログラミングを練習するオンラインアプリである．
工学院大学機械工学科の学生なら，2年次に数値計算の問題に取り組むアプリ「数値計算チャレンジ!」を経験しているはずだが，それに似ているアプリである．違いはプログラミングが必要な課題を提供している点である．

## KodingBasicsのはじめかた

KodingBasicsサイトにアクセスする。

<https://kodingbasics.firebaseapp.com/>
